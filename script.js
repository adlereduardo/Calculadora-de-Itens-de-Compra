...
// Captura o campo de entrada do nome do produto.
...
document.getElementById("adicionar").addEventListener("click", function () {
    ...
    const valorProduto = parseFloat (valorInput.value); //Converte o vlaor do campo para um número de ponto flutuante.

    // Verifica se o nome do produto foi preenchido, se o valor numérico é positivo.
...
if (nomeProduto && !isNaN (valorProduto) && valorProduto > 0) {
    ...
    alert ("Por favor, insira um nome de produto válido e um valor")
  }
  ...
  document.getElementById("visualizarTabela").addEventListener("click", function(){
    ...
    // Itera sobre o array de produtos e adicionar uma linha para cada produto na tabela.
    produtos.forEach(function(produto) {
        ...
        // Formata o valor do produto com duas casas decimais

        // Adiciona as células á linha.
        ...
        // Atualiza o valor total no rodape da tabela, também formatado com duas casas decimais.
